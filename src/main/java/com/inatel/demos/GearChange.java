...
public class GearChange {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Reduce Function
    // This function returns the sum of gear changes of each car.
    ...
    // This function maps only the car with gear changes and not consider the current gear
    static class MapGearChange implements FlatMapFunction<Tuple3<String, Integer, Integer>, Tuple2<String, Integer>> {
      @Override
    ...
    // Map Function - Prints the car id and the number of gear changes 
    static class GearChangePrinter implements MapFunction<Tuple2<String, Integer>, String> {
      ...
      public String map(Tuple2<String, Integer> gearChangeEntry) throws Exception {
        return  String.format("Car%s : %d", gearChangeEntry.f0 , gearChangeEntry.f1 ) ;
      }
    }
